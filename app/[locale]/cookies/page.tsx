...
export const metadata = {
  title: "Política de Cookies | Merchan.Dev SaaS",
  description: "Política de Cookies de Merchan.Dev SaaS GESTION SL.",
};
          ...
          <div className="space-y-10 text-gray-700 leading-relaxed">
            <section>
              ...
              <ul className="list-none space-y-2 text-gray-600">
                ...
                <li><strong className="text-gray-900">Domicilio:</strong> AVDA MARE DE DEU DE MONTSERRAT, NUM 18, PLANTA 5, PUERTA 2, 08970 SANT JOAN DESPÍ (España)</li>
                <li><strong className="text-gray-900">Correo electrónico:</strong> <a href="mailto:info@saas.merchan.dev" className="text-[#D4AF37] hover:underline font-medium">info@saas.merchan.dev</a></li>
              </ul>
            </section>
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-950 mb-4">4. Cookies utilizadas en saas.merchan.dev</h2>
