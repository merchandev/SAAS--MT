...
export const metadata = {
  title: "Nueva Contraseña | Transfers in Barcelona Premium Mobility",
      ...
      <div className="hidden lg:flex lg:w-1/2 relative flex-col justify-between p-12">
        ...
        <div className="relative z-10 max-w-lg mb-12">
          <h2 className="text-4xl font-serif font-bold text-white mb-6">
            Seguridad a <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D4AF37] to-[#AA8B2C] italic">tu medida</span>.
          </h2>
          <p className="text-gray-300 text-lg leading-relaxed">
            Ingresa tu nueva contraseña para volver a acceder a tu historial de reservas y servicios corporativos.
          </p>
        </div>
      </div>
