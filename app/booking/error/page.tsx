    ...
    <main className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <section className="max-w-md w-full rounded-xl border bg-white p-8 text-center shadow-lg">
        ...
        <p className="mb-6 text-gray-600">
          Redsys no ha confirmado el pago. Puedes volver a intentarlo o contactar con el equipo de MeTransfers
          si necesitas ayuda con la reserva.
        </p>

        <div className="flex flex-col gap-3 sm:flex-row sm:justify-center">
          <Link href="/booking" className="rounded-md bg-blue-600 px-5 py-2 text-sm font-medium text-white hover:bg-blue-700">
            Nueva reserva
          </Link>
