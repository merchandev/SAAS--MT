          ...
          <div className="space-y-10 text-gray-700 leading-relaxed">
            <section>
              ...
              <ul className="list-none space-y-2 text-gray-600">
                ...
                <li><strong className="text-gray-900">Contacto Privacidad:</strong> <a href="mailto:info@metransfers.es" className="text-[#D4AF37] hover:underline font-medium">info@metransfers.es</a></li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-5 space-y-2 text-gray-600 marker:text-[#D4AF37]">
                ...
                <li><strong className="text-gray-900">Atención al Cliente:</strong> Resolver dudas y proporcionar soporte a través del punto único de contacto info@metransfers.es.</li>
            ...
            <section>
              ...
              <p className="mb-4 text-gray-600">
                Usted puede ejercer sus derechos de Acceso, Rectificación, Supresión, Limitación, Portabilidad y Oposición enviando una comunicación escrita acompañada de copia de su DNI a: <a href="mailto:info@metransfers.es" className="text-[#D4AF37] hover:underline font-medium">info@metransfers.es</a>.
              </p>
              <p className="text-gray-600">
