...
export const metadata = {
  title: "Registro | Merchan.Dev SaaS Premium Mobility",
  description: "Crea tu cuenta en Merchan.Dev SaaS y accede a servicios de movilidad VIP.",
};
      ...
      <div className="hidden lg:flex lg:w-1/2 relative flex-col justify-between p-12">
        ...
        <div className="relative z-10 max-w-lg mb-12">
          ...
          <p className="text-gray-300 text-lg leading-relaxed">
            Al registrarte en Merchan.Dev SaaS obtienes un perfil de cliente con historial de traslados, gastos y seguimiento de tus servicios.
          </p>
        </div>
      </div>
