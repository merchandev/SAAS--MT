...
export default function PaymentsPage() { 
  return (
    <div className="space-y-6 max-w-5xl mx-auto pt-6">
      <div>
        <h3 className="text-3xl font-bold tracking-tight text-gray-900">Liquidaciones y Pagos</h3>
        <p className="text-gray-500 mt-2">Control de pagos, facturas y liquidaciones B2B.</p>
      </div>
