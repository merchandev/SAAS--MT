...
const staticPages = [
  { slug: 'inicio', name: 'Inicio (Home)', title: 'Merchan.Dev SaaS | Chauffeur & Private Transfers', metaDescription: 'Luxury private transfers and chauffeur service in Barcelona.' },
  ...
  { slug: 'blog', name: 'Blog', title: 'Travel Blog | Merchan.Dev SaaS', metaDescription: 'Tips and news about traveling in Barcelona.' },
