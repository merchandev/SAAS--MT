      ...
      <div className={cn("flex h-16 items-center border-b border-gray-200", isCollapsed ? "justify-center px-0" : "px-4")}>
        <Link href="/admin/dashboard" className="relative block w-full h-10">
          <img
            ...
            alt={companyName}
            className={cn(
              "absolute top-1/2 -translate-y-1/2 left-0 h-8 w-auto object-contain transition-opacity duration-500 ease-in-out",
          ...
          <img
            ...
            alt="TIB"
            className={cn(
              "absolute top-1/2 -translate-y-1/2 h-8 w-auto object-contain transition-opacity duration-500 ease-in-out",
